                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 ${errors.status ? 'border-red-300' : 'border-amber-300'
                                            }`}
                                        required
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 ${errors.tracking_number ? 'border-red-300' : 'border-amber-300'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={4}
                                        className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 resize-none ${errors.shipping_address ? 'border-red-300' : 'border-amber-300'
                                            }`}
