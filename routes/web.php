...
Route::prefix('index.php')->group(function() {
    ...
    Route::post('/newsletter', function (Illuminate\Http\Request $request) {
        ...
        return redirect()->route('index.php.home')->with('success', 'Thank you for subscribing!');
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/dashboard', function () {
            ...
            if ($user->hasRole('admin')) {
                return redirect()->route('index.php.admin.dashboard');
            } elseif ($user->hasRole('buyer')) {
                return redirect()->route('index.php.buyer.dashboard');
            }
